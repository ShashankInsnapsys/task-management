                ...
                <div class="card-header pb-0 px-3">
                    <div class="row">
                        ...
                        <div class="col-6 align-items-end text-end">
                            <button type="button" class="btn btn-sm bg-gradient-dark mb-0" data-bs-toggle="modal" data-bs-target="#add-new-task"><i class="fas fa-plus"
                    ...
                    <ul class="list-group">
                        ...
                        @if (count($tasks) > 0)
                            @foreach ($tasks as $task)
                                <li class="list-group-item border-1 p-4 mb-2 bg-gray-100 border-radius-lg task-item" data-task-id="{{ $task->id }}"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <span class="text-xs">Complete:
                                                    <span class="text-dark ms-sm-2 font-weight-bold">
                                                        <input type="checkbox" class="toggle-completion" data-task-id="{{ $task->id }}"
                                        ...
                                        <div class="col-3 my-auto">
                                            <div class="ms-auto text-end">
                                                <button class="btn btn-link text-dark px-3 mb-0" data-bs-toggle="modal" data-bs-target="#edit-task-id-{{ $task->id }}"><i
                                                ...
                                                <button class="btn btn-link text-danger text-gradient px-3 mb-0" data-bs-toggle="modal"
                                                    data-bs-target="#delete-task-id-{{ $task->id }}"><i class="far fa-trash-alt me-2"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" id="edit-task-form-task-name" name="name" type="text"
            ...
            <div class="card h-100">
                <div class="card-header pb-0 p-3">
                    <div class="row">
                        ...
                        <div class="col-6 align-items-end text-end">
                            <button type="button" class="btn btn-sm bg-gradient-dark mb-0" data-bs-toggle="modal" data-bs-target="#add-new-project"><i
                                    class="fas fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;Add New Project</button>
                        </div>
                    </div>
                    ...
                    @if (count($projects) > 0)
                        <ul class="list-group">
                            ...
                            @foreach ($projects as $project)
                                        ...
                                        <div class="ms-auto col-5">
                                            <div class="text-end">
                                                <button class="btn btn-link text-dark px-3 mb-0" data-bs-toggle="modal"
                                                    data-bs-target="#edit-project-id-{{ $project->id }}"><i class="fas fa-pencil-alt text-dark me-2"
                                                        aria-hidden="true"></i>Edit</button>
                                                <button class="btn btn-link text-danger text-gradient px-3 mb-0" data-bs-toggle="modal"
                                                    data-bs-target="#delete-project-id-{{ $project->id }}"><i class="far fa-trash-alt me-2"
                                                        aria-hidden="true"></i>Delete</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="modal fade" id="edit-project-id-{{ $project->id }}" tabindex="-1" role="dialog"
                                    aria-labelledby="edit-project-id-{{ $project->id }}" aria-hidden="true">
                                    <div class="modal-dialog modal- modal-dialog-centered modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" id="edit-project-form-project-name" name="name" type="text"
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" type="color" id="edit-project-form-project-color" name="color"
                                                                    value="{{ $project->color }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="modal fade" id="delete-project-id-{{ $project->id }}" tabindex="-1" role="dialog"
                                    aria-labelledby="delete-project-id-{{ $project->id }}" aria-hidden="true">
                                    <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h6 class="modal-title" id="modal-title-notification">Your attention is required</h6>
